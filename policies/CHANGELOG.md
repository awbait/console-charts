...
### Changed
- **Вкладки, разделы и колонки формы заказа названы терминами Kubernetes.**
  Вместо «Входящие» и «Исходящие» - «Ingress правила» и «Egress правила», вместо
  «Источников» и «Получателей» - «From» и «To». Поля правила и их описания
  остались прежними.

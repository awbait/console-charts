...
- **Добавили поддержку общих правил размещения точек входа.** Платформа
  задаёт правила для всех точек входа вашего заказа, например исключает ноды,
  с которых внешний адрес не объявляется в сеть. Такое исключение защищает
  точку входа от недоступности снаружи по этой причине. Правила применяются,
  если платформа задала их в значениях своей установки. Вам ничего

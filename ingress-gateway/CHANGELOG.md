...
### Changed
- **Имя гейтвея теперь до 9 символов**, а не до 6. Шести хватало не всегда, а
  имя видно в названии каждого ресурса гейтвея. Имена маршрута и сертификата
  остались прежними, от 2 до 6 символов.

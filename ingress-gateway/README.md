...
|----------------|--------------------------------------------------------------------|
| платформенный  | имя задано прямо в записи `tls.platform`                            |
| ваш            | `store` записи, а если он не задан - `tls.store`                    |

Платформенные записи называют своё хранилище явно, поэтому выбор хранилища в
заказе на них не влияет.
